...
\begin{theorem}[Фокально-директрисное свойство эллипса]
...
\begin{theorem}[Асимптоты гиперболы]
...
\begin{theorem}[Отражательное свойство эллипса]
...
\begin{theorem}[Отражательное свойство параболы]
