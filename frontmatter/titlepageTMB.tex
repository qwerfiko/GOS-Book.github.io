...
{\Huge Подготовка к итоговому экзамену по высшей математике}\\[0.4\baselineskip]
...
\begin{itemize}[wide, labelindent=0pt, label=$\blacktriangleright$, noitemsep]
...
\item Гугл-опрос, который прошу вас заполнить после сдачи устного экзамена:
...
\textcolor{red}{
$\blacktriangleright$ Не рекомендуется использовать данное пособие как \textit{\textbf{основное}} во время подготовки к итоговому экзамену.
}
