...
\providecommand{\theHstt}{\thechapter.\arabic{sttT}}
...
\def\@makechapterhead#1{%
	{\noindent
		...
		\begin{scope}[on background layer]
		\draw [line width=2pt, rounded corners=14pt, chapclr, fill=prpl!20] (n.north -| current page.east) -| (n.south west) -- (n.south -| current page.east);
		\end{scope}
		\end{tikzpicture}%
		\fi\bigskip\par
}}
